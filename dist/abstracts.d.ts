...
export declare abstract class AbstractLoggerService {
     ...
     */
    protected abstract format(level: LoggerLevel, message: string, metadata?: Metadata): string;
    /**
 ...
 */
export declare abstract class AbstractLoggerFactory {
    /**
     ...
     */
    static create(_configuration: ILoggerConfiguration): AbstractLoggerService;
}
